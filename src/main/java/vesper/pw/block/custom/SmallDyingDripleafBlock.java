...
public class SmallDyingDripleafBlock extends TallPlantBlock implements Fertilizable, Waterloggable {

    public static final MapCodec<SmallDyingDripleafBlock> CODEC = createCodec(SmallDyingDripleafBlock::new);
    ...
    @Override
    public MapCodec<SmallDyingDripleafBlock> getCodec() {
        return CODEC;
    }

    public SmallDyingDripleafBlock(AbstractBlock.Settings settings) {
        super(settings);
