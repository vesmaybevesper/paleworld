...
public class PaleAxolotlModel extends EntityModel<PaleAxolotlRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 1).cuboid(-4.0F, -2.0F, -5.0F, 8.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 21.0F, -3.0F));
        ...
        ModelPartData leftGills = modelPartData.addChild("leftGills", ModelPartBuilder.create().uv(12, 41).cuboid(1.0F, -6.0F, 0.5F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(10, 42).cuboid(0.0F, -5.0F, 0.5F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(13, 40).cuboid(2.0F, -7.0F, 0.5F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(12, 45).cuboid(1.0F, -2.0F, 0.5F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(11, 46).cuboid(0.0F, -1.0F, 0.5F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(4.0F, 24.0F, -4.5F));

        ModelPartData topGills = modelPartData.addChild("topGills", ModelPartBuilder.create().uv(4, 39).cuboid(-3.0F, -1.0F, 0.0F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(3, 37).cuboid(-4.0F, -3.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(10, 37).cuboid(3.0F, -3.0F, 0.0F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(8, 39).cuboid(1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(9, 38).cuboid(2.0F, -2.0F, 0.0F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(3, 38).cuboid(-4.0F, -2.0F, 0.0F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 19.0F, -4.0F));

        ModelPartData rightGills = modelPartData.addChild("rightGills", ModelPartBuilder.create().uv(2, 42).cuboid(-1.0126F, -5.0F, -0.4843F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(1, 41).cuboid(-2.0126F, -6.0F, -0.4843F, 1.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(0, 44).cuboid(-3.1816F, -3.0F, -0.0277F, 1.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(1, 46).cuboid(-2.1816F, -1.0F, -0.0277F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F))
                .uv(0, 45).cuboid(-3.1816F, -2.0F, -0.0277F, 2.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-4.0F, 24.0F, -4.5F, 0.0F, -0.2182F, 0.0F));
        ...
        ModelPartData Body = modelPartData.addChild("Body", ModelPartBuilder.create().uv(0, 11).cuboid(-4.0F, -4.0F, -5.0F, 8.0F, 4.0F, 10.0F, new Dilation(0.0F))
                .uv(2, 21).cuboid(0.0F, -5.0F, 0.0F, 0.0F, 5.0F, 5.0F, new Dilation(0.0F))
                .uv(6, 21).cuboid(0.0F, -5.0F, -5.0F, 0.0F, 5.0F, 5.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 2.0F));
